    ...
    <div class="main-content">
        ...
        <form action="{{ route('admin.buses.update', $bus->id) }}" method="POST">
            ...
            <div>
                ...
                <input type="text" name="bus_number" id="bus_number" class="form-input mt-1 block w-full" value="{{ $bus->bus_number }}" required>
            </div>
            <div class="mt-4">
                <label for="driver" class="block text-sm font-medium text-gray-700">Driver</label>
                <input type="text" name="driver" id="driver" class="form-input mt-1 block w-full" value="{{ $bus->driver }}" required>
            </div>
            <div class="mt-4">
            ...
            <div class="mt-6">
                <button type="submit" class="bg-blue-600 text-white px-4 py-2 rounded-lg">Update Bus</button>
            </div>
        </form>
