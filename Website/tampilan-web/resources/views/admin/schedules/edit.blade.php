    ...
    <div class="main-content">
        ...
        <div class="form-container">
            <form action="{{ route('admin.schedules.update', $schedule->id) }}" method="POST">
                ...
                <input type="number" name="bus_id" id="bus_id" value="{{ $schedule->bus_id }}" required>

                <label for="route_id">Route ID:</label>
                <input type="number" name="route_id" id="route_id" value="{{ $schedule->route_id }}" required>

                <label for="departure_time">Departure Time:</label>
                <input type="time" name="departure_time" id="departure_time" value="{{ $schedule->departure_time }}" required>
